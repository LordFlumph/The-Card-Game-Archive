namespace CardGameArchive
{
    ...
    public class GameInfo : ScriptableObject
    {
		...
		[field: SerializeField][field: TextArea(3, 15)] public string AboutText { get; private set; } = "<b><size=+10>Overview</size></b>\n<b><size=+10>History</size></b>\n<b><size=+10>Today</size></b>";
		[field: SerializeField] public GameObject GuideObject { get; private set; }
