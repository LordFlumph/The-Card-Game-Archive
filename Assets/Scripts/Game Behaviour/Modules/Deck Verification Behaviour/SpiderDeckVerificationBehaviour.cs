namespace CardGameArchive.Behaviours
{
	...
	[CreateAssetMenu(fileName = "SpiderDeckVerificationBehaviour", menuName = "Card Game Archive/Game Behaviour/Modules/Deck Verification Behaviours/Spider")]
	public class SpiderDeckVerificationBehaviour : BaseDeckVerificationBehaviour
	{
		protected override bool VerifyDeck()
		{
			Deck deck = GameBoard.Instance.GetDeck();
			BaseGameRules Rules = BaseGameRules.ActiveRules;
