namespace CardGameArchive.Behaviours
{
	...
	[CreateAssetMenu(fileName = "DisableAllButBottomCardEventBehaviour", menuName = "Card Game Archive/Game Behaviour/Modules/Card Event Behaviours/Disable All But Bottom Card")]
