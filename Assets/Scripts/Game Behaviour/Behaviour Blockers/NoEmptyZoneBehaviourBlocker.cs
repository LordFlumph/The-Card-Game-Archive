namespace CardGameArchive.Behaviours
{
	...
	public class NoEmptyZoneBehaviourBlocker : BaseBehaviourBlocker<List<ZoneParent>>
	{
		...
		protected override void OnBehaviourBlocked(List<ZoneParent> blockedParents)
		{
			if (blockedParents != null)
			{
